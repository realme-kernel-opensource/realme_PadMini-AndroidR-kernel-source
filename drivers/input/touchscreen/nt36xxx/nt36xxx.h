...
struct md_debug_info {
	struct coordinate coordinate[10];
};

struct debug_gesture_record_info {
...
//--- Customized Info---
#define TOUCHPANEL_NAME "touchpanel"
...
struct nvt_ts_data {
	...
	struct md_debug_info md_debug_info;
	struct debug_gesture_record_info debug_gesture_record_info;
	struct nvt_fw_debug_info nvt_fw_debug_info;
    struct proc_dir_entry *touchpanel_proc;
