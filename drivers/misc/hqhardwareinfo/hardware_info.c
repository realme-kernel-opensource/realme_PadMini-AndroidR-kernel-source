...
#define HARDWARE_INFO_VERSION   "realme"
#define HARDWARE_INFO_VERSION_2 "realme"
#define HARDWARE_INFO_WCN       "realme"
#define HARDWARE_INFO_WCN_2     "realme"
...
static int __init hq_prj_name_setup(char *str)
{
	...
	if (strncmp(hw_info_prj_name, "216F", 4) == 0)
		prj_name_flag = 1;
	return 0;
}
__setup("prj_name=", hq_prj_name_setup);
...
//fanjiafeng5  add end
extern void  himax_get_tp_fw_ver(void); // for na500
extern void  fts_get_tp_fw_ver(void);
