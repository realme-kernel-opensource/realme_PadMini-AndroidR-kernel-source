...
/* Timeout after 80 msecs if NOP OUT hangs without response */
#define NOP_OUT_TIMEOUT    80 /* msecs */
			       ...
			       struct ufs_dev_desc *dev_desc)
{
	...
	#ifdef CONFIG_T_PRODUCT_INFO
	pr_err("Here is flash information start");
    FULL_PRODUCT_DEVICE_CB(ID_FLASH, get_mmc_chip_info, hba);
	printk("Here is flash information end");
	#endif
	/*
