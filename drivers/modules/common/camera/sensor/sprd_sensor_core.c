...
static char _main_camera_sn[17];
static char _sub_camera_sn[17];
static char _main2_camera_sn[17];
static char _main3_camera_sn[17];
                        ...
                        size_t size)
{
    ...
    if( NULL != temp_p )
    {
        memcpy(_main_camera_sn, temp_p+4, 17);
    ...
    if( NULL != temp_p )
    {
       memcpy(_sub_camera_sn, temp_p+4, 17);
