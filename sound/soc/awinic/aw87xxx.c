...
static void aw87xxx_free_sceen_param(struct aw87xxx_scene_param *scene_param){
...
/*	int i;
	...
	aw87xxx_free_sceen_param(&aw87xxx->aw87xxx_scene_ls.aw_off);
	aw87xxx_free_sceen_param(&aw87xxx->aw87xxx_scene_ls.aw_music);
	aw87xxx_free_sceen_param(&aw87xxx->aw87xxx_scene_ls.aw_voice);
	aw87xxx_free_sceen_param(&aw87xxx->aw87xxx_scene_ls.aw_fm);
	aw87xxx_free_sceen_param(&aw87xxx->aw87xxx_scene_ls.aw_rcv);
				     ...
				     struct device_node *np)
{
	...
	snprintf(aw87xxx->bus_num, sizeof(aw87xxx->bus_num), "%d",
		 aw87xxx->i2c_seq);
