...
static void sprd_mic_capmode_init(void)
{
	sci_adi_set(CODEC_REG(ANA_PMU1), MIC1_BIAS_CAPMODE_SEL);
	sci_adi_set(CODEC_REG(ANA_PMU1), MIC2_BIAS_CAPMODE_SEL);

	pr_info("set MIC1/MIC2 capmode!\n");
}
